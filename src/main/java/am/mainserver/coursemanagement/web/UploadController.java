...
public class UploadController {
    ...
    private static final String UPLOADED_FOLDER = "H:\\couresemanagement\\images\\userImages\\";
    ...
    @PostMapping("/upload")
    public String singleFileUpload(@RequestParam("file") MultipartFile file, Principal principal,RedirectAttributes redirectAttributes,Model model) {
        ...
        try {
            ...
            if (imageService.getImageByUserId(userService.getUserId(principal.getName())) != null) {
                imageService.deleteUserImage(userService.getUserId(principal.getName()));
            }
